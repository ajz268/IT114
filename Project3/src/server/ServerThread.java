...
public class ServerThread extends Thread {
	...
	protected void addMute(String client) {
		mutedUsers.add(client);

	}

	protected void removeMute(String client) {
		mutedUsers.remove(client);
	}
	...
	protected boolean send(String clientName, String message) {
		if (mutedUsers.contains(clientName)) {
			return true;
		} else {
